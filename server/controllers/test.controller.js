...
class Tests {
	...
	async create(req, res, next) {
		try {
			...
			const creator = req.user; // Assuming the authenticated user is available in the `req.user` property
			console.log(courseId, episodeId)
			...
			const formattedQuestions = testInformation.questions.map((question) => ({
				...question,
				episode: episodeId,
				course: courseId,
			}));
