...
export default function EpisodeComment({ comment }) {
  ...
  if (inEdition)
    return <EditComment setInEdition={setInEdition} prevComment={comment} />;
    ...
    <li className="comment">
      <article>
          ...
          <img
            src={
              comment.creator.profileImage
                ? `${IMAGES_ROUTES}${comment.creator.profileImage}`
                : { UserImage }
            }
          />
        ...
        <div className="actions">
          ...
          {showTools && (
            <Tools setInEdition={setInEdition} commentId={comment.id} />
          )}
        </div>
      </article>
    </li>
