...
const confirmpasswordPattern = /[\w]{8,16}/;
...
const INITIAL_VALUES = {
  ...
  confirmPassword: {
    value: "",
    isCorrect: false,
    validation: confirmpasswordPattern,
  },
};
...
export default function SignupForm() {
  ...
  const isInfoCorrect =
    correctInputs.length === TOTAL_INPUTS.length && passwordMatch;
  ...
  function handleConfirmPasswordChange(event) {
    ...
    const isMatched = confirmPassword === form.password.value;
